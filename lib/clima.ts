...
/**
 * Busca a previsão do tempo atual para um município.
 * Aceita nomes como "Redenção - CE" ou "Redenção, CE" (usa só a
 * parte antes do separador para geocodificar).
 * Retorna `null` se o município não for encontrado ou a API falhar
 * — o chamador deve tratar isso como "clima indisponível", nunca
 * como erro fatal.
 */
